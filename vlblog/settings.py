...
MIDDLEWARE = [
    ...
    'mainblog.middleware.CurrentRequestMiddlewareUser',
]

ROOT_URLCONF = 'vlblog.urls'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'peresvet.smt7101@gmail.com'
EMAIL_HOST_PASSWORD = 'oxmpnmygpiadoydg'
...
SUMMERNOTE_CONFIG = {
    'summernote': {
        ...
        # 'fontNames': ['Arial', 'Times New Roman', 'Courier New', 'Consolas',],
